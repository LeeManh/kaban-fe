...
export function CardAttachFilePopoverContent({ boardId, cardId }: { boardId: string; cardId: string }) {
  ...
  function handleInsert() {
    ...
    presignAttachment.mutate({ file: selectedFile, displayName: displayText });
  }
