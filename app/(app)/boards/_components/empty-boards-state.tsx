...
export function EmptyBoardsState() {
  return (
    <div className="flex flex-col items-center rounded-md border border-border bg-card px-6 py-12 text-center shadow-xs">
      ...
      <div className="mb-1.5 text-[17px] font-bold tracking-[-0.01em] text-foreground">
        No boards yet
      </div>
      <div className="mb-5 max-w-85 text-[13.5px] leading-[1.55] text-muted-foreground">
