    ...
    <section className="py-22">
      <Container className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
        <div className="w-full max-w-120 shrink-0">
          <div className="-rotate-[1.5deg] overflow-hidden rounded-md border border-border bg-card shadow-[0_30px_60px_--theme(--color-slate-900/16%)]">
            ...
            <div className="px-4.5 py-4">
              <div className="mb-2.75 flex items-center gap-2.25">
                <SquareCheckBig className="size-3.75 text-muted-foreground" strokeWidth={2} />
              ...
              <div className="mb-3.5 h-1.75 overflow-hidden rounded bg-muted">
              ...
              <div className="mb-4.5 flex flex-col gap-2.25">
                ...
                <div className="flex items-center gap-2.25">
                  <span className="size-4 rounded-md border-2 border-border" />
              ...
              <div className="mb-2.75 flex items-center gap-2.25">
                <Paperclip className="size-3.75 text-muted-foreground" strokeWidth={2} />
                <span className="text-[13px] font-bold text-foreground">
                  Attachments
                </span>
              </div>
              <div className="flex items-center gap-2.5 rounded-md border border-border p-2">
                ...
                <div className="flex-1">
                  <div className="mb-1.25 h-1.5 w-4/5 rounded bg-muted-foreground/25" />
                  <div className="h-1.25 w-1/2 rounded bg-muted" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mb-6 max-w-110 text-base leading-[1.65] text-muted-foreground">
          ...
          <div className="flex flex-col gap-3.5">
            {HIGHLIGHTS.map((highlight) => (
              <div key={highlight} className="flex items-center gap-3">
                <span className="flex size-6.5 shrink-0 items-center justify-center rounded-full bg-emerald-50 text-green-600 dark:bg-emerald-950">
