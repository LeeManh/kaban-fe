...
export function About() {
  return (
    <section id="about" className="scroll-mt-17 border-y border-slate-200 bg-slate-50">
      <Container className="flex flex-col items-center gap-12 py-22 lg:flex-row lg:gap-16">
        <div className="min-w-0 flex-1">
          ...
          <p className="mb-5 max-w-120 text-base leading-[1.65] text-slate-600">
          ...
          <p className="max-w-120 text-base leading-[1.65] text-slate-600">
        ...
        <div className="grid w-full max-w-100 shrink-0 grid-cols-2 gap-4">
          {STATS.map((stat) => (
            ...
            >
              ...
              <div className="text-[13px] font-semibold text-slate-500">{stat.label}</div>
            </div>
          ))}
        </div>
      </Container>
