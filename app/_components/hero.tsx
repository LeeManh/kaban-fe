...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50/60 via-white to-white dark:from-blue-950/30 dark:via-background dark:to-background">
      ...
      <Container className="relative flex flex-col items-center gap-12 py-18 lg:flex-row lg:py-22">
        <div className="w-full max-w-120 shrink-0">
          <div className="mb-5.5 inline-flex items-center gap-1.75 rounded-full border border-blue-100 bg-blue-50 px-3 py-1.25 text-xs font-bold text-primary dark:border-blue-900 dark:bg-blue-950">
            <span className="size-1.5 rounded-full bg-green-500" />
            Now with real-time collaboration
          </div>
          <h1 className="mb-4.5 text-4xl leading-[1.05] font-extrabold tracking-tight text-foreground sm:text-5xl">
            Organize work the simple way
          </h1>
          <p className="mb-7.5 max-w-108 text-[17px] leading-relaxed text-muted-foreground">
        ...
        >
          ...
          >
            ...
            <div className="flex h-9.5 items-center gap-1.75 border-b border-border bg-card px-3.5">
              ...
              <span className="ml-3 text-xs font-bold text-foreground">Product Roadmap</span>
            </div>
            <div className="flex items-start gap-2.75 p-4">
              ...
              <MockColumn title="Review" count={1} countClassName="bg-muted text-muted-foreground">
...
function MockColumn({
  ...
  return (
    <div className="w-42.5 shrink-0 rounded-md bg-muted p-2.25">
...
function MockCard({
  ...
  return (
    <div className="rounded-md bg-card p-2.25 shadow-sm">
      ...
      <div
        className={
            ...
            ? "text-[11px] leading-snug font-medium text-muted-foreground line-through decoration-muted-foreground"
            : "text-[11px] leading-snug font-medium text-foreground"
        }
      >
        {title}
      </div>
